...
- Informer-кеш (watch) у `cronops-server` — списки/лічильники з кешу замість прямих LIST до K8s API на кожен запит (зокрема `GET /projects`, який зараз сканує всі задачі заради `jobCount`)
